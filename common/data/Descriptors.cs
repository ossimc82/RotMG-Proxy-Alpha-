...
public class ProjectileDesc
{
    public ProjectileDesc(XElement elem)
    {
        ...
        if (elem.Attribute("id") != null)
            BulletType = ServerUtils.FromString(elem.Attribute("id").Value);
        ObjectId = elem.Element("ObjectId").Value;
        LifetimeMS = ServerUtils.FromString(elem.Element("LifetimeMS").Value);
        Speed = float.Parse(elem.Element("Speed").Value, NumberStyles.Any, ci);
        if ((n = elem.Element("Size")) != null)
            Size = ServerUtils.FromString(n.Value);

        XElement dmg = elem.Element("Damage");
        if (dmg != null)
            MinDamage = MaxDamage = ServerUtils.FromString(dmg.Value);
        else
        {
            MinDamage = ServerUtils.FromString(elem.Element("MinDamage").Value);
            MaxDamage = ServerUtils.FromString(elem.Element("MaxDamage").Value);
        }
...
public class ActivateEffect
{
    public ActivateEffect(XElement elem)
    {
        ...
        if (elem.Attribute("stat") != null)
            Stats = ServerUtils.FromString(elem.Attribute("stat").Value);

        if (elem.Attribute("amount") != null)
            Amount = ServerUtils.FromString(elem.Attribute("amount").Value);
        ...
        if (elem.Attribute("maxDistance") != null)
            MaximumDistance = ServerUtils.FromString(elem.Attribute("maxDistance").Value);
        ...
        if (elem.Attribute("totalDamage") != null)
            TotalDamage = ServerUtils.FromString(elem.Attribute("totalDamage").Value);

        if (elem.Attribute("objectId") != null)
            ObjectId = elem.Attribute("objectId").Value;

        if (elem.Attribute("angleOffset") != null)
            AngleOffset = ServerUtils.FromString(elem.Attribute("angleOffset").Value);

        if (elem.Attribute("maxTargets") != null)
            MaxTargets = ServerUtils.FromString(elem.Attribute("maxTargets").Value);
...
public class Item
{
    public Item(short type, XElement elem)
    {
        try
        {
            ...
            SetType = elem.Attribute("setType") != null ? ServerUtils.FromString(elem.Attribute("setType").Value) : -1;
            SlotType = ServerUtils.FromString(elem.Element("SlotType").Value);
            if ((n = elem.Element("Tier")) != null)
                try
                {
                    Tier = ServerUtils.FromString(n.Value);
                }
                catch
                {
                    Tier = -1;
            ...
            BagType = (n = elem.Element("BagType")) != null ? ServerUtils.FromString(n.Value) : 0;
            MpCost = (n = elem.Element("MpCost")) != null ? ServerUtils.FromString(n.Value) : 0;
            FeedPower = (n = elem.Element("feedPower")) != null ? ServerUtils.FromString(n.Value) : 0;
            FameBonus = (n = elem.Element("FameBonus")) != null ? ServerUtils.FromString(n.Value) : 0;
            NumProjectiles = (n = elem.Element("NumProjectiles")) != null ? ServerUtils.FromString(n.Value) : 1;
            ArcGap = (n = elem.Element("ArcGap")) != null ? ServerUtils.FromString(n.Value) : 11.25f;
            ...
            Doses = (n = elem.Element("Doses")) != null ? ServerUtils.FromString(n.Value) : 0;
            ...
            if (elem.Element("Soulbound") != null)
            {
                if (elem.Element("ActivateOnEquip") == null)
                    Soulbound = true;
                int s = ServerUtils.FromString(elem.Element("SlotType").Value);
                if (s == 10 || s == 26)
                    Soulbound = true;
...
public class SpawnCount
{
    ...
    {
        Mean = ServerUtils.FromString(elem.Element("Mean").Value);
        StdDev = ServerUtils.FromString(elem.Element("StdDev").Value);
        Min = ServerUtils.FromString(elem.Element("Min").Value);
        Max = ServerUtils.FromString(elem.Element("Max").Value);
    }
...
public class ObjectDesc
{
    public ObjectDesc(ushort type, XElement elem)
    {
        ...
        if ((n = elem.Element("Size")) != null)
        {
            MinSize = MaxSize = ServerUtils.FromString(n.Value);
            SizeStep = 0;
        }
        else
        {
            MinSize = (n = elem.Element("MinSize")) != null ? ServerUtils.FromString(n.Value) : 100;
            MaxSize = (n = elem.Element("MaxSize")) != null ? ServerUtils.FromString(n.Value) : 100;
            SizeStep = (n = elem.Element("SizeStep")) != null ? ServerUtils.FromString(n.Value) : 0;
        }
        ...
        {
            MaxHitPoints = n.Attribute("max") != null ? ServerUtils.FromString(n.Attribute("max").Value) : -1;
            MaxHP = ServerUtils.FromString(n.Value);
        }
        if ((n = elem.Element("MaxMagicPoints")) != null)
            MaxMagicPoints = n.Attribute("max") != null ? ServerUtils.FromString(n.Attribute("max").Value) : -1;

        if ((n = elem.Element("Attack")) != null)
            MaxAttack = n.Attribute("max") != null ? ServerUtils.FromString(n.Attribute("max").Value) : -1;
        if ((n = elem.Element("Dexterity")) != null)
            MaxDexterity = n.Attribute("max") != null ? ServerUtils.FromString(n.Attribute("max").Value) : -1;
        if ((n = elem.Element("Speed")) != null)
            MaxSpeed = n.Attribute("max") != null ? ServerUtils.FromString(n.Attribute("max").Value) : -1;
        if ((n = elem.Element("HpRegen")) != null)
            MaxHpRegen = n.Attribute("max") != null ? ServerUtils.FromString(n.Attribute("max").Value) : -1;
        if ((n = elem.Element("MpRegen")) != null)
            MaxMpRegen = n.Attribute("max") != null ? ServerUtils.FromString(n.Attribute("max").Value) : -1;

        if ((n = elem.Element("Defense")) != null)
        {
            Defense = ServerUtils.FromString(n.Value);
            MaxDefense = n.Attribute("max") != null ? ServerUtils.FromString(n.Attribute("max").Value) : -1;
        }
        ...
        if ((n = elem.Element("Level")) != null)
            Level = ServerUtils.FromString(n.Value);
        else
            Level = null;
        ...
        if ((n = elem.Element("PerRealmMax")) != null)
            PerRealmMax = ServerUtils.FromString(n.Value);
        else
            PerRealmMax = null;
...
public class TileDesc
{
    public TileDesc(ushort type, XElement elem)
    {
        ...
        {
            MinDamage = ServerUtils.FromString(n.Value);
            Damaging = true;
        }
        if ((n = elem.Element("MaxDamage")) != null)
        {
            MaxDamage = ServerUtils.FromString(n.Value);
            Damaging = true;
        }
        if ((n = elem.Element("Speed")) != null)
...
public class DungeonDesc
{
    public DungeonDesc(XElement elem)
    {
        ...
        ci.NumberFormat.CurrencyDecimalSeparator = ".";
        Name = elem.Attribute("name").Value;
        PortalId = (ushort) ServerUtils.FromString(elem.Attribute("type").Value);
        Background = ServerUtils.FromString(elem.Element("Background").Value);
